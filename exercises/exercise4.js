const dogs = [
    ...
    },
    {
        ...
        temperament: ['Even Tempered', 'Kind', 'Gentle']
    }
];
...
// 1) Create a new array that contains the OBJECTS of the dogs that are 'Kind'
// 2) Create a new array that contains the NAMES of the dogs that are 'Kind'
const kindDogs = null;
